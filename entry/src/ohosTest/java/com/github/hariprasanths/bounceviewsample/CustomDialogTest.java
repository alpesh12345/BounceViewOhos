...
public class CustomDialogTest {
    ...
    @Test
    public void testGetSetButtonCustomComponent() {
        CustomDialog myCommonDialog = new CustomDialog(context);
        myCommonDialog.setButtonCustomComponent(mComponent);
        assertEquals(myCommonDialog.getButtonCustomComponent(),mComponent);
    }
    ...
    public void testSetCommonButton() {
        CustomDialog myCommonDialog = new CustomDialog(context);
        myCommonDialog.setCommonButton(0, string, 0, 0, component -> { });
        assertNotNull(myCommonDialog.getButtonCustomComponent());
    }

    @Test
    public void testSetCommonImageButton() {
        CustomDialog myCommonDialog = new CustomDialog(context);
        myCommonDialog.setCommonImageButton(0, 0, 0, ResourceTable.Media_icon, component -> { });
        assertNotNull(myCommonDialog.getButtonCustomComponent());
    }
